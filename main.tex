...
\section{Conclusão}
Este trabalho apresentou uma análise de patentes brasileiras com o objetivo de identificar tecnologias emergentes relacionadas à produção de etanol. Os resultados mostraram que o modelo Random Forest obteve maior F1-Score final (49,23\%) enquanto o SVM apresentou F1-Score inferior (35,29\%), e ambos alcançaram AUROC acima de 85\%, indicando capacidade discriminativa moderada. A qualidade e a cobertura dos dados mostraram-se fatores limitantes para o desempenho; trabalhos futuros devem ampliar e consolidar fontes de dados, explorar calibração de limiar, técnicas de balanceamento de classes e incorporar novas características que capturem melhor a evolução tecnológica.
